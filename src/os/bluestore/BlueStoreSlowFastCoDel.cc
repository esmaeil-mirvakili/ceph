...
void BlueStoreSlowFastCoDel::on_config_changed(CephContext *cct) {
  {
    ...
    slow_interval = (int64_t) millisec_to_nanosec(
            cct->_conf->bluestore_codel_slow_interval);
    initial_fast_interval = (int64_t) millisec_to_nanosec(
            cct->_conf->bluestore_codel_fast_interval);
    initial_target_latency = (int64_t) millisec_to_nanosec(
            cct->_conf->bluestore_codel_initial_target_latency);
    min_target_latency = (int64_t) millisec_to_nanosec(
            cct->_conf->bluestore_codel_min_target_latency);
    max_target_latency = (int64_t) millisec_to_nanosec(
            cct->_conf->bluestore_codel_max_target_latency);
