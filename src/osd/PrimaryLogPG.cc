...
//    int64_t op_write_full = ctx->log_write_full;
    ...
    int64_t op_dispatched = 1;
    int64_t op_enqueued = 1;
    int64_t op_dequeued = 1;
    int64_t op_started = 1;
    int64_t op_done = 1;
    int64_t op_read = true;
    int64_t op_write = false;
    int64_t op_write_full = true;
